...
# Load DRYa lib 2
   source $v_REPOS_CENTER/DRYa/all/lib/libs/drya-lib-2-tmp-n-config-files.sh
...
function f_1_pt {
   echo "Shiva Sutra #1:"
   echo " > Oh Radiante, esta experiência pode alvorecer entre dois fôlegos. Depois de entrar entrar (para baixo) e precisamente antes de voltar para cima (para fora) - o beneficio."
}
...
function f_16_pt {
   echo "Shiva Sutra #16: "
   echo " > Abençoada, como os sentidos são absorvidos no coração, alcansa o centro da lotus."
}
...
a)
   ...
   osho | o | O)
      ...
      case $2 in 
         ...
         *) 
            echo "ss: --osho <number>"
            echo "choose a sutra to be explained by Osho"
         ;;
      esac
   ;;
   nn | NN | --NN)
   ...
   help)
      ...
      echo "ss --osho {1..112}            :Gives description of each sutra (by Osho)"
